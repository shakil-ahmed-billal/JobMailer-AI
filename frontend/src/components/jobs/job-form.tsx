...
const inputCls =
  "h-10 rounded-xl border-border/60 bg-muted/30 text-sm focus-visible:ring-violet-500/30 focus-visible:border-violet-500/50 transition-all placeholder:text-muted-foreground/50";
const selectTriggerCls =
  "h-10 rounded-xl border-border/60 bg-muted/30 text-sm focus:ring-violet-500/30 focus:border-violet-500/50";
const labelCls =
            ...
            <div>
              ...
              <DialogDescription className="text-xs text-muted-foreground mt-0.5">
                {isEditing
                  ...
                  : "Fill in the details to start tracking this opportunity."}
              </DialogDescription>
            </div>
          </div>
        </div>
