...
const inputCls =
  "h-10 rounded-xl border-border/60 bg-muted/30 text-sm focus-visible:ring-violet-500/30 focus-visible:border-violet-500/50 placeholder:text-muted-foreground/50";
const labelCls =
            ...
            <div>
              ...
              <DialogDescription className="text-xs text-muted-foreground mt-0.5">
                {isEditing
                  ...
                  : "Create a new task to track for this job."}
              </DialogDescription>
            </div>
          </div>
        </div>
